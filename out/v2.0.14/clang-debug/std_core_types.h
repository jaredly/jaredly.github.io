...
static inline kk_reuse_t kk_std_core_types__tuple4__dropn_reuse(kk_std_core_types__tuple4_ _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_basetype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__tuple4__dropn(kk_std_core_types__tuple4_ _x, size_t _scan_fsize, kk_context_t* _ctx) {
...
static inline kk_reuse_t kk_std_core_types___lp__comma__comma__comma__comma__rp__dropn_reuse(kk_std_core_types___lp__comma__comma__comma__comma__rp_ _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_basetype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types___lp__comma__comma__comma__comma__rp__dropn(kk_std_core_types___lp__comma__comma__comma__comma__rp_ _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_basetype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__alloc_dropn_reuse(kk_std_core_types__alloc _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__alloc_dropn(kk_std_core_types__alloc _x, size_t _scan_fsize, kk_context_t* _ctx) {
...
// value type std/core/types/any
enum kk_std_core_types__any_e {
  kk_std_core_types_any_empty
};
typedef uint32_t kk_std_core_types__any;
...
static inline kk_std_core_types__any kk_std_core_types__any_unbox(kk_box_t _x, kk_context_t* _ctx) {
  return (kk_std_core_types__any)kk_enum_unbox(_x);
}
...
struct kk_std_core_types_CTail {
  kk_box_t _field1;
  kk_box_t* _field2;
};
struct kk_std_core_types_CTailNil {
  kk_box_t _unused;
};
struct kk_std_core_types_ctail_s {
  kk_value_tag_t _tag;
  union {
    struct kk_std_core_types_CTail CTail;
    struct kk_std_core_types_CTailNil CTailNil;
    kk_box_t _fields[1];
  } _cons;
};
typedef struct kk_std_core_types_ctail_s kk_std_core_types__ctail;
static inline kk_std_core_types__ctail kk_std_core_types__new_CTail(kk_box_t _field1, kk_box_t* _field2, kk_context_t* _ctx){
  kk_std_core_types__ctail _con;
  _con._tag = kk_value_tag(1);
  _con._cons.CTail._field1 = _field1;
  _con._cons.CTail._field2 = _field2;
  return _con;
}
static inline kk_std_core_types__ctail kk_std_core_types__new_CTailNil(kk_context_t* _ctx){
  kk_std_core_types__ctail _con;
...
static inline bool kk_std_core_types__is_CTailNil(kk_std_core_types__ctail x) {
  return (kk_integer_small_eq(x._tag, kk_value_tag(2)));
}
static inline size_t kk_std_core_types__ctail_scan_count(kk_std_core_types__ctail _x) {
  if (kk_std_core_types__is_CTail(_x)) return 2;
  else return 1;
}
static inline kk_std_core_types__ctail kk_std_core_types__ctail_dup(kk_std_core_types__ctail _x) {
  if (kk_std_core_types__is_CTail(_x)) {
    kk_box_dup(_x._cons.CTail._field1);
  }
  return _x;
}
static inline void kk_std_core_types__ctail_drop(kk_std_core_types__ctail _x, kk_context_t* _ctx) {
  if (kk_std_core_types__is_CTail(_x)) {
    kk_box_drop(_x._cons.CTail._field1, _ctx);
  }
}
static inline kk_box_t kk_std_core_types__ctail_box(kk_std_core_types__ctail _x, kk_context_t* _ctx) {
  kk_box_t _box;
  kk_valuetype_box(kk_std_core_types__ctail, _box, _x, kk_std_core_types__ctail_scan_count(_x), _ctx);
  return _box;
}
...
static inline kk_reuse_t kk_std_core_types__div_dropn_reuse(kk_std_core_types__div _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__div_dropn(kk_std_core_types__div _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__ediv_dropn_reuse(kk_std_core_types__ediv _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__ediv_dropn(kk_std_core_types__ediv _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline size_t kk_std_core_types__either_scan_count(kk_std_core_types__either _x) {
...
static inline kk_reuse_t kk_std_core_types__global_dropn_reuse(kk_std_core_types__global _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__global_dropn(kk_std_core_types__global _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__handled_dropn_reuse(kk_std_core_types__handled _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__handled_dropn(kk_std_core_types__handled _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__handled1_dropn_reuse(kk_std_core_types__handled1 _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__handled1_dropn(kk_std_core_types__handled1 _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__hbox_dropn_reuse(kk_std_core_types__hbox _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_basetype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__hbox_dropn(kk_std_core_types__hbox _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_basetype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__hdiv_dropn_reuse(kk_std_core_types__hdiv _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__hdiv_dropn(kk_std_core_types__hdiv _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__int_dropn_reuse(kk_std_core_types__int _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__int_dropn(kk_std_core_types__int _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_std_core_types__int16 kk_std_core_types__int16_dup(kk_std_core_types__int16 _x) {
  return _x;
}
...
static inline kk_std_core_types__int16 kk_std_core_types__int16_unbox(kk_box_t _x, kk_context_t* _ctx) {
...
static inline kk_std_core_types__int8 kk_std_core_types__int8_dup(kk_std_core_types__int8 _x) {
  return _x;
}
...
static inline kk_std_core_types__int8 kk_std_core_types__int8_unbox(kk_box_t _x, kk_context_t* _ctx) {
...
static inline kk_reuse_t kk_std_core_types__local_dropn_reuse(kk_std_core_types__local _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__local_dropn(kk_std_core_types__local _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__local_var_dropn_reuse(kk_std_core_types__local_var _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__local_var_dropn(kk_std_core_types__local_var _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline size_t kk_std_core_types__maybe_scan_count(kk_std_core_types__maybe _x) {
...
static inline kk_reuse_t kk_std_core_types__ndet_dropn_reuse(kk_std_core_types__ndet _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__ndet_dropn(kk_std_core_types__ndet _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline size_t kk_std_core_types__optional_scan_count(kk_std_core_types__optional _x) {
...
static inline kk_reuse_t kk_std_core_types__read_dropn_reuse(kk_std_core_types__read _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__read_dropn(kk_std_core_types__read _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__ref_dropn_reuse(kk_std_core_types__ref _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__ref_dropn(kk_std_core_types__ref _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__reuse_dropn_reuse(kk_std_core_types__reuse _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__reuse_dropn(kk_std_core_types__reuse _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
// value type std/core/types/size_t
enum kk_std_core_types__size__t_e {
  kk_std_core_types_size__t_empty
};
typedef uint32_t kk_std_core_types__size__t;

static inline kk_std_core_types__size__t kk_std_core_types__size__t_dup(kk_std_core_types__size__t _x) {
  return _x;
}
static inline void kk_std_core_types__size__t_drop(kk_std_core_types__size__t _x, kk_context_t* _ctx) {
  
}
static inline kk_box_t kk_std_core_types__size__t_box(kk_std_core_types__size__t _x, kk_context_t* _ctx) {
  return kk_enum_box(_x);
}
static inline kk_std_core_types__size__t kk_std_core_types__size__t_unbox(kk_box_t _x, kk_context_t* _ctx) {
  return (kk_std_core_types__size__t)kk_enum_unbox(_x);
}
...
static inline kk_reuse_t kk_std_core_types__write_dropn_reuse(kk_std_core_types__write _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__write_dropn(kk_std_core_types__write _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__total__dropn_reuse(kk_std_core_types__total_ _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__total__dropn(kk_std_core_types__total_ _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__extend__dropn_reuse(kk_std_core_types__extend_ _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__extend__dropn(kk_std_core_types__extend_ _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__string_dropn_reuse(kk_std_core_types__string _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__string_dropn(kk_std_core_types__string _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
// value type std/core/types/uint8
enum kk_std_core_types__uint8_e {
  kk_std_core_types_uint8_empty
};
typedef uint8_t kk_std_core_types__uint8;

static inline kk_std_core_types__uint8 kk_std_core_types__uint8_dup(kk_std_core_types__uint8 _x) {
  return _x;
}
static inline void kk_std_core_types__uint8_drop(kk_std_core_types__uint8 _x, kk_context_t* _ctx) {
  
}
static inline kk_box_t kk_std_core_types__uint8_box(kk_std_core_types__uint8 _x, kk_context_t* _ctx) {
  return kk_enum_box(_x);
}
static inline kk_std_core_types__uint8 kk_std_core_types__uint8_unbox(kk_box_t _x, kk_context_t* _ctx) {
  return (kk_std_core_types__uint8)kk_enum_unbox(_x);
}
...
static inline kk_reuse_t kk_std_core_types__vector_dropn_reuse(kk_std_core_types__vector _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__vector_dropn(kk_std_core_types__vector _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_reuse_t kk_std_core_types__void_dropn_reuse(kk_std_core_types__void _x, size_t _scan_fsize, kk_context_t* _ctx) {
  return kk_datatype_dropn_reuse(_x, _scan_fsize, _ctx);
}
static inline void kk_std_core_types__void_dropn(kk_std_core_types__void _x, size_t _scan_fsize, kk_context_t* _ctx) {
  kk_datatype_dropn(_x, _scan_fsize, _ctx);
}
...
static inline kk_box_t kk_std_core_types_fst_2(kk_std_core_types__tuple4_ _this, kk_context_t* _ctx) { /* forall<a,b,c,d> ((a, b, c, d)) -> a */ 
  struct kk_std_core_types__Tuple4_* _con2565 = kk_std_core_types__as_dash__lp__comma__comma__comma__rp_(_this);
  kk_box_t _x = _con2565->fst;
  kk_box_t _pat0 = _con2565->snd;
  kk_box_t _pat1 = _con2565->thd;
  kk_box_t _pat2 = _con2565->field4;
...
static inline kk_box_t kk_std_core_types_snd_2(kk_std_core_types__tuple4_ _this, kk_context_t* _ctx) { /* forall<a,b,c,d> ((a, b, c, d)) -> b */ 
  struct kk_std_core_types__Tuple4_* _con2566 = kk_std_core_types__as_dash__lp__comma__comma__comma__rp_(_this);
  kk_box_t _pat0 = _con2566->fst;
  kk_box_t _x = _con2566->snd;
  kk_box_t _pat1 = _con2566->thd;
  kk_box_t _pat2 = _con2566->field4;
  if (kk_std_core_types__tuple4__is_unique(_this)) {
    kk_box_drop(_pat2, _ctx);
    kk_box_drop(_pat1, _ctx);
    kk_box_drop(_pat0, _ctx);
...
static inline kk_box_t kk_std_core_types_thd_1(kk_std_core_types__tuple4_ _this, kk_context_t* _ctx) { /* forall<a,b,c,d> ((a, b, c, d)) -> c */ 
  struct kk_std_core_types__Tuple4_* _con2567 = kk_std_core_types__as_dash__lp__comma__comma__comma__rp_(_this);
  kk_box_t _pat0 = _con2567->fst;
  kk_box_t _pat1 = _con2567->snd;
  kk_box_t _x = _con2567->thd;
  kk_box_t _pat2 = _con2567->field4;
  if (kk_std_core_types__tuple4__is_unique(_this)) {
    kk_box_drop(_pat2, _ctx);
    kk_box_drop(_pat1, _ctx);
    kk_box_drop(_pat0, _ctx);
...
static inline kk_box_t kk_std_core_types_field4(kk_std_core_types__tuple4_ _this, kk_context_t* _ctx) { /* forall<a,b,c,d> ((a, b, c, d)) -> d */ 
  struct kk_std_core_types__Tuple4_* _con2568 = kk_std_core_types__as_dash__lp__comma__comma__comma__rp_(_this);
  kk_box_t _pat0 = _con2568->fst;
  kk_box_t _pat1 = _con2568->snd;
  kk_box_t _pat2 = _con2568->thd;
  kk_box_t _x = _con2568->field4;
  if (kk_std_core_types__tuple4__is_unique(_this)) {
    kk_box_drop(_pat2, _ctx);
    kk_box_drop(_pat1, _ctx);
    kk_box_drop(_pat0, _ctx);
...
static inline kk_box_t kk_std_core_types_fst_3(kk_std_core_types___lp__comma__comma__comma__comma__rp_ _this, kk_context_t* _ctx) { /* forall<a,b,c,d,a1> ((a, b, c, d, a1)) -> a */ 
  struct kk_std_core_types__lp__comma__comma__comma__comma__rp_* _con2577 = kk_std_core_types__as_dash__lp__comma__comma__comma__comma__rp_(_this);
  kk_box_t _x = _con2577->fst;
  kk_box_t _pat0 = _con2577->snd;
  kk_box_t _pat1 = _con2577->thd;
  kk_box_t _pat2 = _con2577->field4;
  kk_box_t _pat3 = _con2577->field5;
...
static inline kk_box_t kk_std_core_types_snd_3(kk_std_core_types___lp__comma__comma__comma__comma__rp_ _this, kk_context_t* _ctx) { /* forall<a,b,c,d,a1> ((a, b, c, d, a1)) -> b */ 
  struct kk_std_core_types__lp__comma__comma__comma__comma__rp_* _con2578 = kk_std_core_types__as_dash__lp__comma__comma__comma__comma__rp_(_this);
  kk_box_t _pat0 = _con2578->fst;
  kk_box_t _x = _con2578->snd;
  kk_box_t _pat1 = _con2578->thd;
  kk_box_t _pat2 = _con2578->field4;
  kk_box_t _pat3 = _con2578->field5;
  if (kk_std_core_types___lp__comma__comma__comma__comma__rp__is_unique(_this)) {
    kk_box_drop(_pat3, _ctx);
    kk_box_drop(_pat2, _ctx);
    kk_box_drop(_pat1, _ctx);
...
static inline kk_box_t kk_std_core_types_thd_2(kk_std_core_types___lp__comma__comma__comma__comma__rp_ _this, kk_context_t* _ctx) { /* forall<a,b,c,d,a1> ((a, b, c, d, a1)) -> c */ 
  struct kk_std_core_types__lp__comma__comma__comma__comma__rp_* _con2579 = kk_std_core_types__as_dash__lp__comma__comma__comma__comma__rp_(_this);
  kk_box_t _pat0 = _con2579->fst;
  kk_box_t _pat1 = _con2579->snd;
  kk_box_t _x = _con2579->thd;
  kk_box_t _pat2 = _con2579->field4;
  kk_box_t _pat3 = _con2579->field5;
  if (kk_std_core_types___lp__comma__comma__comma__comma__rp__is_unique(_this)) {
    kk_box_drop(_pat3, _ctx);
    kk_box_drop(_pat2, _ctx);
    kk_box_drop(_pat1, _ctx);
...
static inline kk_box_t kk_std_core_types_field4_1(kk_std_core_types___lp__comma__comma__comma__comma__rp_ _this, kk_context_t* _ctx) { /* forall<a,b,c,d,a1> ((a, b, c, d, a1)) -> d */ 
  struct kk_std_core_types__lp__comma__comma__comma__comma__rp_* _con2580 = kk_std_core_types__as_dash__lp__comma__comma__comma__comma__rp_(_this);
  kk_box_t _pat0 = _con2580->fst;
  kk_box_t _pat1 = _con2580->snd;
  kk_box_t _pat2 = _con2580->thd;
  kk_box_t _x = _con2580->field4;
  kk_box_t _pat3 = _con2580->field5;
  if (kk_std_core_types___lp__comma__comma__comma__comma__rp__is_unique(_this)) {
    kk_box_drop(_pat3, _ctx);
    kk_box_drop(_pat2, _ctx);
    kk_box_drop(_pat1, _ctx);
...
static inline kk_box_t kk_std_core_types_field5(kk_std_core_types___lp__comma__comma__comma__comma__rp_ _this, kk_context_t* _ctx) { /* forall<a,b,c,d,a1> ((a, b, c, d, a1)) -> a1 */ 
  struct kk_std_core_types__lp__comma__comma__comma__comma__rp_* _con2581 = kk_std_core_types__as_dash__lp__comma__comma__comma__comma__rp_(_this);
  kk_box_t _pat0 = _con2581->fst;
  kk_box_t _pat1 = _con2581->snd;
  kk_box_t _pat2 = _con2581->thd;
  kk_box_t _pat3 = _con2581->field4;
  kk_box_t _x = _con2581->field5;
  if (kk_std_core_types___lp__comma__comma__comma__comma__rp__is_unique(_this)) {
    kk_box_drop(_pat3, _ctx);
    kk_box_drop(_pat2, _ctx);
    kk_box_drop(_pat1, _ctx);
...
static inline kk_std_core_types__box kk_std_core_types__copy_5(kk_std_core_types__box _this, kk_std_core_types__optional unbox0, kk_context_t* _ctx) { /* forall<a> (box<a>, unbox : optional<a>) -> box<a> */ 
  ...
  if (kk_std_core_types__is_Optional(unbox0)) {
    kk_box_t _unbox_2065 = unbox0._cons.Optional.value;
    kk_std_core_types__box_drop(_this, _ctx);
    _x2592 = _unbox_2065; /*2074*/
  }
  else {
    kk_box_t _x = _this.unbox;
    _x2592 = _x; /*2074*/
  }
  return kk_std_core_types__new_Box(_x2592, _ctx);
}
 
// Automatically generated. Tests for the `CTail` constructor of the `:ctail` type.

static inline bool kk_std_core_types_is_ctail(kk_std_core_types__ctail ctail, kk_context_t* _ctx) { /* forall<a> (ctail : ctail<a>) -> bool */ 
  if (kk_std_core_types__is_CTail(ctail)) {
...
static inline bool kk_std_core_types_is_ctailNil(kk_std_core_types__ctail ctail, kk_context_t* _ctx) { /* forall<a> (ctail : ctail<a>) -> bool */ 
  if (kk_std_core_types__is_CTailNil(ctail)) {
    return true;
  }
  kk_std_core_types__ctail_drop(ctail, _ctx);
  return false;
...
static inline kk_box_t kk_std_core_types_unhbox(kk_std_core_types__hbox hbox0, kk_context_t* _ctx) { /* forall<a> (hbox : hbox<a>) -> a */ 
  struct kk_std_core_types_Hbox* _con2593 = kk_std_core_types__as_Hbox(hbox0);
  kk_box_t _x = _con2593->unhbox;
  if (kk_std_core_types__hbox_is_unique(hbox0)) {
...
static inline kk_unit_t kk_std_core_types__cfield_set(kk_box_t* field, kk_box_t res, kk_context_t* _ctx) { /* forall<a> (field : cfield<a>, res : a) -> () */ 
  *(field) = res; return kk_Unit;
}

static inline kk_std_core_types__ctail kk_std_core_types__ctail_link(kk_std_core_types__ctail acc, kk_box_t res, kk_box_t* field, kk_context_t* _ctx) { /* forall<a> (acc : ctail<a>, res : a, field : cfield<a>) -> ctail<a> */ 
  if (kk_std_core_types__is_CTail(acc)) {
    kk_box_t head = acc._cons.CTail._field1;
    kk_box_t* last = acc._cons.CTail._field2;
    kk_unit_t __ = kk_Unit;
    *(last) = res;
    return kk_std_core_types__new_CTail(head, field, _ctx);
  }
  return kk_std_core_types__new_CTail(res, field, _ctx);
}

static inline kk_std_core_types__ctail kk_std_core_types__ctail_nil(kk_context_t* _ctx) { /* forall<a> () -> ctail<a> */ 
  return kk_std_core_types__new_CTailNil(_ctx);
}

static inline kk_box_t kk_std_core_types__ctail_resolve(kk_std_core_types__ctail acc, kk_box_t rest, kk_context_t* _ctx) { /* forall<a> (acc : ctail<a>, rest : a) -> a */ 
  if (kk_std_core_types__is_CTail(acc)) {
    kk_box_t head = acc._cons.CTail._field1;
    kk_box_t* last = acc._cons.CTail._field2;
    kk_unit_t __ = kk_Unit;
...
static inline kk_box_t kk_std_core_types_local_scope(kk_function_t action, kk_context_t* _ctx) { /* forall<e,a> (action : forall<h> () -> <local<h>|e> a) -> e a */ 
